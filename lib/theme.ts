...
function readColors(dir: string): ThemeColors | null {
...
function listThemes(siteRoot: string): { builtIn: ThemeInfo[]; user: ThemeInfo[] } {
...
function printThemeCard(name: string, type: 'built-in' | 'user', colors: ThemeColors | null): void {
...
function createTheme(name: string, siteRoot: string): boolean {
...
function validateTheme(themePath: string): { valid: boolean; error?: string } {
...
export { listThemes, pickTheme, createTheme, validateTheme, BUILT_IN_THEMES_DIR };