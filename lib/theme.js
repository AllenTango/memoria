...
exports.BUILT_IN_THEMES_DIR = void 0;
exports.listThemes = listThemes;
exports.pickTheme = pickTheme;
...
exports.BUILT_IN_THEMES_DIR = BUILT_IN_THEMES_DIR;
// ── Helpers ─────────────────────────────────────────────────────────────
...
function printThemeCard(name, type, colors) {
    ...
    if (colors) {
        ...
        if (colors.accent)
            console.log(`           强调: ${colors.accent}`);
        if (colors.heading)
            console.log(`           标题: ${colors.heading}`);
    }
}
